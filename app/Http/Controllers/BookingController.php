...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'pickup_designation' => 'nullable|string|in:home,school,work,other',
            'destination_designation' => 'nullable|string|in:home,school,work,other',
        ...
        $booking = Booking::create([
            ...
            'pickup_designation' => $validated['pickup_designation'] ?? null,
            ...
            'destination_designation' => $validated['destination_designation'] ?? null,
