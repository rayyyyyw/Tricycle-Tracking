                                ...
                                <tr>
                                    <td>
                                        @if($isNewUser)
                                            ...
                                            <p style="margin: 0 0 20px 0; font-size: 14px; color: #059669; font-weight: 600;">You signed up with Google</p>
                                        @else
                                            <h1 style="margin: 0 0 8px 0; font-size: 20px; font-weight: 700; color: #111827;">You signed in to TriGo</h1>
                                            <p style="margin: 0 0 20px 0; font-size: 14px; color: #059669; font-weight: 600;">Signed in with Google</p>
                                        @endif
