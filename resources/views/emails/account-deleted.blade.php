...
<head>
    ...
    <title>Your TriGo account has been deleted</title>
</head>
                    ...
                    <tr>
                        <td style="background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1); overflow: hidden;">
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="padding: 32px 28px;">
                                <tr>
                                    <td>
                                        <h1 style="margin: 0 0 8px 0; font-size: 20px; font-weight: 700; color: #111827;">Account permanently deleted</h1>
                                        <p style="margin: 0 0 20px 0; font-size: 14px; color: #b91c1c; font-weight: 600;">Your TriGo account has been removed</p>
                                        <p style="margin: 0 0 16px 0; font-size: 15px; line-height: 1.6; color: #374151;">Hi {{ $userName }},</p>
                                        <p style="margin: 0 0 16px 0; font-size: 15px; line-height: 1.6; color: #374151;">
                                            Your TriGo account has been permanently deleted by an administrator. You will no longer be able to sign in or use the service.
                                        </p>
