        ...
        <div className="min-h-screen flex bg-white dark:bg-gray-900 transition-colors">
            ...
            <div className="flex-1 flex items-center justify-center p-8">
                <div className="w-full max-w-md">
                    ...
                    <div className="flex items-center justify-center space-x-3 mb-8">
                        <div className="w-12 h-12 bg-linear-to-r from-emerald-400 to-green-500 rounded-xl flex items-center justify-center shadow-sm">
            ...
            <div className="flex-1 bg-linear-to-br from-green-50 via-white to-emerald-50 dark:from-gray-800 dark:via-gray-900 dark:to-emerald-900 hidden lg:flex items-center justify-center p-12 border-l border-green-100 dark:border-gray-700">
                <div className="max-w-lg text-center">
                    {/* Icon/Logo */}
                    <div className="w-24 h-24 bg-linear-to-r from-emerald-400 to-green-500 rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-lg">
