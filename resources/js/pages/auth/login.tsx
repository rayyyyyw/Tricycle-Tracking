        ...
        <div className="flex min-h-screen bg-white transition-colors dark:bg-gray-900">
            ...
            <div className="flex flex-1 items-center justify-center p-8">
                <div className="w-full max-w-md">
                    ...
                    {/* Login Card */}
                    <div className="rounded-2xl border border-green-100 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <>
                                    <div className="grid gap-6">
                                        <div className="grid gap-2">
                                            ...
                                            <Input
                                                ...
                                                className="h-11 border-gray-300 bg-white placeholder-gray-500 focus:border-green-500 focus:ring-green-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                                            />
                                            <InputError
                                        ...
                                        <div className="flex items-center space-x-3">
                                            <Checkbox
                                                ...
                                                name="remember"
                                                tabIndex={3}
                                                className="border-gray-300 data-[state=checked]:border-green-500 data-[state=checked]:bg-green-500 dark:border-gray-600 dark:data-[state=checked]:border-green-600 dark:data-[state=checked]:bg-green-600"
                                            />
                                            <Label
                                                htmlFor="remember"
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <Button
                                            ...
                                            className="flex h-10 items-center justify-center gap-2 border border-gray-300 bg-white text-gray-700 transition-all duration-200 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600"
                                        >
                                            <svg
                                                className="h-4 w-4"
                                                viewBox="0 0 24 24"
                                        ...
                                        <Button
                                            ...
                                            className="flex h-10 items-center justify-center gap-2 border border-[#1877F2] bg-[#1877F2] text-white transition-all duration-200 hover:bg-[#166FE5]"
                                        >
                                            <svg
                                                className="h-4 w-4"
                                                fill="currentColor"
            ...
            <div className="hidden flex-1 items-center justify-center border-l border-green-100 bg-linear-to-br from-green-50 via-white to-emerald-50 p-12 lg:flex dark:border-gray-700 dark:from-gray-800 dark:via-gray-900 dark:to-emerald-900">
                <div className="max-w-lg text-center">
                    ...
                    <p className="mb-8 text-lg leading-relaxed text-gray-600 dark:text-gray-300">
                        Real-time GPS tracking and fleet management for your
                        tricycle business. Monitor locations, optimize routes,
                        and improve operational efficiency.
                    </p>

                    {/* Features List */}
                    <div className="space-y-4 rounded-2xl border border-green-100 bg-white/50 p-6 text-left backdrop-blur-sm dark:border-gray-700 dark:bg-gray-800/50">
                    ...
                    {/* Stats */}
                    <div className="mt-8 flex justify-center gap-8 border-t border-green-200 pt-8 dark:border-gray-600">
                        <div className="text-center">
