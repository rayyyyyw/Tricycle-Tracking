    ...
    return {
        ...
        features: [
            ...
            },
            {
                ...
                title: 'Data Export',
                description:
                    'Export reports and data for analysis and record keeping.',
            },
        ],
        how_it_works: [
...
export default function AdminSettings() {
    ...
    const settingsForm = useForm<SettingsFormData>({
        theme: getInitialTheme(adminProfile?.theme) as
            | 'light'
            | 'dark'
            | 'system',
    ...
    const getTeamMemberImageUrl = useCallback(
        (avatar: string): string | null => {
            if (!avatar) return null;
            if (avatar.startsWith('http') || avatar.startsWith('/'))
                return avatar;
            if (
                /\.(jpe?g|png|gif|webp)$/i.test(avatar) ||
                avatar.startsWith('team-members/')
            )
    ...
    const serverLanding = page.props.landingPageContent as
    ...
    const landingForm = useForm<LandingFormData>({
        ...
        about_paragraphs:
            ...
            landing.about_paragraphs.length > 0
                ? landing.about_paragraphs
                : ['', ''],
        about_highlights:
            Array.isArray(landing.about_highlights) &&
            landing.about_highlights.length > 0
                ? landing.about_highlights
                : (defaults.about_highlights ?? []),
        features:
            Array.isArray(landing.features) && landing.features.length > 0
                ? landing.features
                : (defaults.features ?? []),
        how_it_works:
            Array.isArray(landing.how_it_works) &&
            landing.how_it_works.length > 0
                ? landing.how_it_works
                : (defaults.how_it_works ?? []),
        team_subtitle: landing.team_subtitle ?? 'The people behind TriGo',
        team_members:
            Array.isArray(landing.team_members) &&
    ...
    const handleLandingSubmit = (e: React.FormEvent) => {
        ...
        landingForm.post('/admin/settings/landing-page', {
            ...
            onError: () =>
                showAlert(
                    'error',
                    'Failed to update about page. Please try again.',
                ),
        });
    };

    const addParagraph = () => {
        landingForm.setData('about_paragraphs', [
            ...landingForm.data.about_paragraphs,
            '',
        ]);
    };
    ...
    const removeParagraph = (index: number) => {
        const next = landingForm.data.about_paragraphs.filter(
    ...
    const addHighlight = () => {
        landingForm.setData('about_highlights', [
            ...landingForm.data.about_highlights,
            { icon: '✨', title: '', desc: '' },
        ]);
    };
    const setHighlight = (
        index: number,
        field: keyof LandingAboutHighlight,
        value: string,
    ) => {
    ...
    const removeHighlight = (index: number) => {
        landingForm.setData(
            'about_highlights',
            landingForm.data.about_highlights.filter(
                (_: LandingAboutHighlight, i: number) => i !== index,
            ),
        );
    };

    const addFeature = () => {
        landingForm.setData('features', [
            ...landingForm.data.features,
            { icon: '✨', title: '', description: '' },
        ]);
    };
    const setFeature = (
        index: number,
        field: keyof LandingFeature,
        value: string,
    ) => {
    ...
    const removeFeature = (index: number) => {
        landingForm.setData(
            'features',
            landingForm.data.features.filter(
                (_: LandingFeature, i: number) => i !== index,
            ),
        );
    };
    ...
    const addHowItWorksStep = () => {
        ...
        landingForm.setData('how_it_works', [
            ...landingForm.data.how_it_works,
            { step: nextNum, title: '', desc: '' },
        ]);
    };
    const setHowItWorksStep = (
        index: number,
        field: keyof LandingHowItWorksStep,
        value: string,
    ) => {
    ...
    const removeHowItWorksStep = (index: number) => {
        landingForm.setData(
            'how_it_works',
            landingForm.data.how_it_works.filter(
                (_: LandingHowItWorksStep, i: number) => i !== index,
            ),
        );
    };

    const addTeamMember = () => {
        landingForm.setData('team_members', [
            ...landingForm.data.team_members,
            {
                name: '',
                role: '',
                avatar: '',
    ...
    const removeTeamMember = (index: number) => {
        landingForm.setData(
            'team_members',
            landingForm.data.team_members.filter(
                (_: LandingTeamMember, i: number) => i !== index,
            ),
        );
    };

    const handleTeamMemberPhotoChange = useCallback(
            ...
            fetch('/admin/settings/team-member-image', {
                ...
                .then((data: { path?: string }) => {
                    ...
                    const next = current.map(
                        (m: LandingTeamMember, i: number) =>
                            i === index
                                ? { ...m, avatar: data.path as string }
                                : { ...m },
                    );
                    landingForm.setData('team_members', next);
                })
                .catch(() =>
                    showAlert(
                        'error',
                        'Failed to upload image. Use JPG, PNG, GIF or WebP under 2MB.',
                    ),
                )
                ...
                <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        ...
                        <p className="ml-14 text-gray-600 dark:text-gray-400">
                            Manage your application preferences, landing page
                            features, how it works, and about content
                        </p>
                    </div>
                </div>
                ...
                <Tabs defaultValue="general" className="w-full">
                    <TabsList className="grid w-full max-w-md grid-cols-2 rounded-lg bg-muted/60 p-1">
                        ...
                        >
                            ...
                            Landing Page
                            {(landingForm.data.team_members?.length ?? 0) >
                                0 && (
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <p className="mb-3 text-sm text-muted-foreground">
                                                When enabled, only admins can
                                                access the app. Takes effect
                                                immediately.
                                            </p>
                        ...
                        <Card className="border-dashed sm:border-solid">
                            <CardContent className="pt-6">
                                <p className="mb-6 text-sm text-muted-foreground">
                                    Control the About section and Meet the Team
                                    on your public about page. Changes appear as
                                    soon as you save.
                                </p>
                                <form
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            <Label htmlFor="about_title">
                                                About heading (e.g. &quot;About
                                                TriGo&quot;)
                                            </Label>
                                            <Input
                                                id="about_title"
                                                value={
                                                    landingForm.data.about_title
                                                }
                                                onChange={(e) =>
                                                    landingForm.setData(
                                                        'about_title',
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {landingForm.data.about_paragraphs.map(
                                                (p: string, i: number) => (
                                                    <div
                                                        key={i}
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {landingForm.data.about_highlights.map(
                                                (
                                                    h: LandingAboutHighlight,
                                                    i: number,
                                                ) => (
                                                    <div
                                                        key={i}
                                                    ...
                                                    >
                                                        ...
                                                        <Input
                                                            ...
                                                            className="w-full min-w-[120px] sm:flex-1"
                                                        />
                                                        <Button
                                                            type="button"
                                                            variant="ghost"
                                    ...
                                    <div className="space-y-4 border-t pt-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {landingForm.data.how_it_works.map(
                                                (
                                                    s: LandingHowItWorksStep,
                                                    i: number,
                                                ) => (
                                                    <div
                                                        key={i}
                                    ...
                                    <div className="space-y-4 border-t pt-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {landingForm.data.team_members.map(
                                                (
                                                    m: LandingTeamMember,
                                                    i: number,
                                                ) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex shrink-0 flex-col items-center gap-1.5">
                                                                <div className="relative flex h-20 w-20 items-center justify-center overflow-hidden rounded-lg border bg-muted text-2xl">
                                                                    {isUploading ? (
                                                                ...
                                                                <div className="flex flex-col gap-1">
                                                                    ...
                                                                    <Label
                                                                        ...
                                                                        className="inline-flex h-8 w-full cursor-pointer items-center justify-center gap-1 rounded-md border border-input bg-background px-3 text-xs font-medium ring-offset-background hover:bg-accent hover:text-accent-foreground"
                                                                    >
