...
export default function Profile() {
    ...
    const hasChanges = useMemo(() => {
        ...
        return (
            Object.keys(initialData).some(
                (key) =>
                    currentData[
                        key as keyof Omit<ProfileFormData, 'avatar'>
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (phone && !/^\+63\d{10}$/.test(phone)) {
            showAlert(
                'error',
                'Please enter a valid Philippine phone number (+63 followed by 10 digits)',
            );
            return;
        }
                                ...
                                <CardContent className="p-8">
                                    <div className="flex flex-col items-center space-y-6">
                                        ...
                                        <div className="relative">
                                            <div className="flex h-48 w-48 items-center justify-center overflow-hidden rounded-full border-4 border-background bg-muted shadow-lg">
                                                {avatarPreview ||
                                                user?.avatar ? (
                                                    <img
                                                        src={
                                                    ...
                                                    <div
                                                        className={`flex h-full w-full items-center justify-center rounded-full ${getAvatarColor()} text-5xl font-semibold text-white`}
                                                    >
                                                        {getUserInitials()}
                                                    </div>
                                                )}
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <p className="text-xs text-muted-foreground">
                                                    Format: +63 followed by 10
                                                    digits (e.g., +639121231234)
                                                </p>
                                    ...
                                    <div className="grid gap-6 md:grid-cols-2">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex h-11 items-center gap-2 rounded-md border border-border bg-accent p-3 text-muted-foreground">
                            ...
                            <CardContent className="pt-6">
                                <div className="text-sm text-destructive">
                                    ...
                                    <ul className="mt-1 list-inside list-disc space-y-1">
                                        {Object.entries(profileForm.errors).map(
                                            ([key, error]) => (
                                                <li key={key}>{error}</li>
                                            ),
                                        )}
