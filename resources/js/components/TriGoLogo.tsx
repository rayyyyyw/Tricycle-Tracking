...
export default function TriGoLogo({
    showText = true,
    size = 'md',
    className = '',
    ...props
    ...
    return (
        <div
            className={`flex flex-col items-center ${sizes[size]} ${className}`}
            {...props}
        >
            ...
            >
                ...
                <g transform="translate(60, 42)">
                    ...
                    <ellipse cx="-8" cy="0" rx="3" ry="4" fill="#10b981" />

                    {/* Headlight */}
                    <circle cx="-10" cy="0" r="1.2" fill="#6ee7b7" />
            ...
            {showText && (
                <div className="mt-2 flex items-center justify-center">
                    <span className="bg-linear-to-r from-emerald-300 via-emerald-400 to-emerald-500 bg-clip-text text-2xl font-bold text-transparent dark:from-emerald-200 dark:via-emerald-300 dark:to-emerald-400">
                        TriGo
                    </span>
                </div>
            )}
