...
export default function MessageIconButton({
    ...
    return (
        <Link
            href={href}
            className={`rounded-md p-1.5 sm:p-2 ${hoverBg} relative flex shrink-0 items-center justify-center transition-colors hover:text-foreground`}
            aria-label="Messages"
        >
            <MessageCircle
                size={16}
